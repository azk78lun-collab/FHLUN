...
sapsbxinstall(){
URL="https://raw.githubusercontent.com/azk78lun-collab/FHLUN/main/sapsbxh.sh"
...
command -v curl > /dev/null 2>&1 && bash <(curl -Ls https://raw.githubusercontent.com/azk78lun-collab/FHLUN/main/saph.sh) || bash <(wget -qO- https://raw.githubusercontent.com/azk78lun-collab/FHLUN/main/saph.sh)
else
...
echo ""
echo ""
echo "Lun小钢炮脚本-SAP多账户自动保活脚本【VPS】"
echo "版本：V25.10.19"
echo "*****************************************************"
echo "*****************************************************"
